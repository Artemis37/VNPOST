...
jQuery(document).ready(function () {
  ...
  jQuery(".hierarchy-node .hierarchy-checkbox").change(function () {
    ...
    document.querySelector('.hierarchy-root-label').click();
    document.querySelectorAll('.hierarchy-label')[0].click();
    document.querySelectorAll('.hierarchy-label')[1].click();
    document.querySelectorAll('.hierarchy-label')[6].click();
    document.querySelectorAll('.hierarchy-label')[13].click();
});